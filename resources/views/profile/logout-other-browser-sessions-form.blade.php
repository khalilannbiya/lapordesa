<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Jika diperlukan, Anda dapat logout dari semua sesi browser Anda pada semua perangkat. Beberapa sesi
            terakhir Anda terdaftar di bawah ini, namun daftar ini mungkin tidak lengkap. Jika Anda merasa akun Anda
            telah diretas, sebaiknya Anda juga memperbarui kata sandi Anda.') }}
        </div>
